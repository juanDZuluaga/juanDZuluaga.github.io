...
function dataFooter() {
    ...
    return(
        <footer className="bg-zinc-900 dark:bg-amber-500">
            <div className="flex items-center justify-center px-4 py-2 text-center">
                <div className="flex items-center space-x-3">
                    <a>
                        <svg className="w-[25px] h-[25px] text-zinc-800" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                    ...
                    <a>
                        <svg className="w-[25px] h-[25px] text-zinc-800" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
