                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
                    <div className="text-center md:text-left">
                        <div className="m-2 floating-container  lg:mt-25 mt-0">
                            <a href="https://www.linkedin.com/in/juan-david-zuluaga-49045b252/" className="inline-flex items-center justify-center p-1.5 col_bt_a transition rounded-4xl" target="_blank" rel="noopener noreferrer">
                                <svg className="w-13 h-13" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                                    <path fillRule="evenodd" d="M12.51 8.796v1.697a3.738 3.738 0 0 1 3.288-1.684c3.455 0 4.202 2.16 4.202 4.97V19.5h-3.2v-5.072c0-1.21-.244-2.766-2.128-2.766-1.827 0-2.139 1.317-2.139 2.676V19.5h-3.19V8.796h3.168ZM7.2 6.106a1.61 1.61 0 0 1-.988 1.483 1.595 1.595 0 0 1-1.743-.348A1.607 1.607 0 0 1 5.6 4.5a1.601 1.601 0 0 1 1.6 1.606Z" clipRule="evenodd" />
                                    <path d="M7.2 8.809H4V19.5h3.2V8.809Z" />
                                </svg>
                                <strong>Linkeding</strong>
                            </a>
                            <a href="https://wa.me/573002965927" className="inline-flex items-center justify-center p-1.5  rounded-4xl col_bt_a transition m-2" target="_blank" rel="noopener noreferrer">
                                <svg className="w-13 h-13" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href=" col_bt_a mailto:jdzuluaga0511@gmail.com?subject=Consulta%20desde%20tu%20sitio&body=Hola,%20quisiera%20más%20información." className="col_bt_a inline-flex items-center justify-center p-1.5 rounded-4xl transition m-2" target="_blank" rel="noopener noreferrer">
                                <svg className="w-13 h-13" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                            ...
                            <a href="tel:3002965927" className="inline-flex items-center justify-center p-1.5 rounded-4xl col_bt_a transition m-2">
                                <svg className="w-13 h-13" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                    ...
                    <div className="lg:mt-0 mt-10">
                        <form className="w-full space-y-6" onSubmit={sendEmail} >
                            ...
                            <div className="col-span-2 text-center">
                                <button type="submit" className="col_bt_a font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">
                                    <span className="flex items-center justify-center gap-2 col_bt_a">
