                ...
                <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0  md:border-0 md:dark:b-zinc-900">
                    <li  className="relative group">
                        <a href="/" className="block py-2 text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:border-0  dark:text-white dark:hover:bg-gray-700  dark:hover:text-white md:dark:hover:bg-transparent">
                            <svg viewBox="0 0 140.45 136.97" fill="currentColor" className="w-8 h-8 transition-colors duration-200">
                    ...
                    <li className="relative group">
                        <button onClick={() => setIsDropdownOpen(!isDropdownOpen)}
                            ...
                            <svg viewBox="0 0 140.45 136.97" fill="currentColor" className="w-8 h-8 transition-colors duration-200">
                                <path d="M138.53,17.99c-1.72-1.81-3.81-2.84-6.33-2.85c-5.44-0.02-10.87-0.01-16.31,0c-0.88,0-1.67-0.11-2.3-0.85
                                    c-2.31-2.75-4.75-5.39-7.13-8.08c-2.12-2.41-4.1-5.08-7.75-5.27c-24.92,0-48.89,0-73.81,0c-1.18,0-2.42,0.39-3.13,0.85
                                    c-3.25,2.11-5.11,4.64-5.11,8.51c0,8.91,0,17.81,0,26.72c0,0.31-0.03,0.63,0.01,0.94c0.09,0.71-0.16,0.96-0.91,1.11
                                    C7.57,40.77,2.13,47.49,2.12,55.88c-0.01,22.04-0.02,44.08,0,66.11c0.01,9.8,7.33,17.1,17.15,17.1c34.45,0.01,68.9,0.01,103.35,0
                                    c8.88,0,15.12-4.82,17.35-13.38c0.06-0.24,0.08-0.67,0.08-0.67c0-34.27,0.24-68.53,0.24-102.81
                                    C140.07,20.68,139.67,19.19,138.53,17.99z M102.82,8.36c5.47,6.15,10.73,12.06,16.15,18.16c-3.39,0-6.55,0-9.71,0
                                    c-1.69,0-4.11,0.22-5.79-0.11c-0.93-0.51-0.62-1.84-0.63-2.79C102.79,18.65,102.82,13.67,102.82,8.36z M20.95,10.09
                                    c0-3.09,1.87-4.98,4.95-4.98c23.6-0.01,47.21,0,70.81-0.02c1.01,0,1.39,0.23,1.38,1.35c-0.06,5.66-0.06,11.33-0.02,17
                                    c0.03,4.43,1.23,6.84,5.62,7.38c2.87,0.22,11.66,0.23,16.74,0.16c1.15-0.02,0.94,0.64,0.94,1.29c0,8.99,0,17.98,0,26.98
                                    c0,18.76-0.01,36.52,0.03,53.28c0,1.1-0.32,1.71-1.48,1.71c-1.75,0.01-5.26-0.21-5.34-0.12c-3.47,0.3-3.59,0.12-3.47-3.11
                                    c0.71-18.38,0.01-36.78-0.01-55.17c-0.01-8.44-5.08-14.93-13.11-16.84c-1.41-0.34-2.84-0.43-4.28-0.43
                                    c-5.44,0.01-10.88-0.02-16.32,0.03c-0.95,0.01-1.16-0.26-1.19-1.18c-0.4-9.97-7.41-17.68-17.24-19.06
                                    c-10.64-1.49-20.97,6.79-21.88,17.55c-0.23,2.65-0.23,2.65-2.9,2.65c-4.05,0-8.09-0.03-12.14,0.02c-0.87,0.01-1.12-0.21-1.12-1.1
                                    C20.96,28.35,20.94,19.22,20.95,10.09z M66.2,35.84c-0.95-4.45-4.89-7.7-9.34-7.64c-4.7,0.07-8.56,3.48-9.25,8.18
                                    c-0.06,0.4-0.14,0.8-0.13,1.2c0.02,0.56-0.15,0.8-0.76,0.78c-1.44-0.04-2.88-0.03-4.32,0c-0.61,0.01-0.73-0.24-0.75-0.8
                                    C41.41,30,48.17,22.75,55.81,22.42c8.82-0.38,15.6,5.6,16.38,14.38c0.11,1.2-0.11,1.78-1.43,1.57c-0.48-0.08-0.99-0.01-1.48-0.01
                                    c0-0.01,0-0.03,0-0.04c-0.9,0-1.97,0.3-2.65-0.08C65.95,37.85,66.38,36.66,66.2,35.84z M61.21,38.07
                                    c-1.13,0.01-2.25-0.05-3.38-0.04c-1.63,0.02-3.27-0.03-4.9,0.01c-0.63,0.01-1.15-0.48-1.09-1.11c0.33-3.19,3.41-5.5,6.82-4.37
                                    c1.89,0.63,3.16,2.42,3.36,4.4C62.09,37.66,61.99,38.07,61.21,38.07z M106.25,134.78c-28.85,0-54.27,0.03-83.12,0.02
                                    c-0.66,0-3.9,0.11-5.39,0c-4.75-0.15-10.54-5.3-11.07-10.64c-0.17-1.71-0.2-3.41-0.2-5.11c0-14.7,0-29.4,0-44.1
                                    c0-1.62,0-1.62,1.47-0.99c11.22,4.8,22.43,9.62,33.67,14.39c0.99,0.42,1.33,0.92,1.28,1.98c-0.09,1.88-0.03,3.78-0.03,5.66
                                    c0.02,4.8,2.54,7.88,7.28,8.15c4.61,0.26,9.26,0.35,13.87-0.1c3.55-0.35,6.26-3.32,6.39-6.88c0.08-2.24,0.08-4.5,0.02-6.74
                                    c-0.03-1.07,0.23-1.66,1.33-2.1c3.42-1.35,6.78-2.85,10.16-4.31c1.53-0.66,2.57-1.69,2.05-2.66c-0.87-1.68-1.99-1.39-4.14-0.45
                                    c-2.76,1.2-5.53,2.37-8.28,3.58c-0.78,0.34-1.11,0.36-1.21-0.7c-0.31-3.08-2.8-5.86-5.85-6.21c-5-0.58-10.05-0.54-15.05-0.06
                                    c-3.91,0.37-6.11,2.95-6.59,6.84c-0.02,0.13-0.08,0.25-0.16,0.51c-2.33-0.99-4.63-1.97-6.93-2.95c-9.36-4.01-18.72-8.03-28.1-12
                                    c-0.91-0.39-1.27-0.86-1.25-1.88c0.07-3.77-0.04-7.55,0.05-11.33c0.12-5.17,2.3-9.15,7.02-11.53c1.41-0.71,2.9-1.2,4.52-1.1
                                    c0.19-0.08,0.37-0.11,0.57-0.12c0.4-0.14,0.83-0.06,1.24-0.06c24.58-0.01,49.16-0.01,73.74,0c5.52,0,9.84,2.12,12.33,7.27
                                    c0.77,1.59,1.15,3.31,1.17,5.07c0.04,4.04-0.01,8.09,0.03,12.13c0.01,0.81-0.27,1.19-1,1.48c-1.78,0.71-10.84,4.66-13.87,5.79
                                    c-0.42,0.16-0.82,0.35-1.23,0.53c-1.36,0.63-1.9,1.37-1.45,2.54c0.61,1.21,2,1.26,3.32,0.67c2.47-1.1,4.99-2.11,7.49-3.15
                                    c0,0,0,0,0,0c2.12-0.94,4.23-1.88,6.51-2.9c0,0.71,0,1.2,0,1.68c0,15.33,0.05,30.65-0.03,45.98c-0.02,5.14,1.39,9.63,5.04,13.33
                                    c0.08,0.08,0.12,0.22,0.26,0.49C110.07,134.78,108.16,134.78,106.25,134.78z M49.34,99.86c-1.87-0.22-2.91-1.25-2.94-3.19
                                    c-0.06-4.09-0.05-8.17,0-12.26c0.02-1.96,1.06-3.01,2.9-3.22c0.2-0.02,0.4-0.02,0.6-0.03c0.29-0.15,0.62-0.09,0.92-0.09
                                    c3.69,0,7.37-0.01,11.06,0.01c2.7,0.02,3.88,1.19,3.88,3.85c0.01,3.87,0.02,7.73-0.01,11.6c-0.02,2.16-1.16,3.41-3.29,3.45
                                    c-4.09,0.07-8.18,0.04-12.27,0.04c-0.13,0-0.25-0.08-0.38-0.12c0,0,0.01,0,0.01,0C49.67,99.88,49.5,99.88,49.34,99.86z
                                    M129.98,131.6c-2.39,1.68-3.52,2.85-7.51,2.75c-6.84-0.33-11.65-4.7-12.04-10.91c-0.09-1.39-0.2-2.77-0.25-4.16
                                    c-0.03-0.95,0.29-1.23,1.23-1.22c3.37,0.05,6.74,0.02,10.11,0.02c2.49,0,3.23-0.74,3.23-3.19c0-27.73-0.01-55.46,0.02-83.19
                                    c0-2.83-0.97-5.14-2.83-7.18c-1.56-1.71-3.27-3.62-4.98-5.54c3.22,0,11.19,0.03,11.19,0.03c1.08-0.02,2.16-0.05,3.24-0.02
                                    c2.25,0.05,3.79,1.58,3.9,3.81c0.02,0.31,0.01,0.63,0.01,0.94c0,32.27,0,64.55,0,96.82C135.31,125.1,133.79,128.93,129.98,131.6z" />
                                <path d="M106.41,134.48c0.07,0,0.12,0,0.2,0c-0.04-0.05-0.09-0.08-0.13-0.13c-0.01,0.03,0,0.05-0.02,0.08
                                    C106.44,134.45,106.42,134.46,106.41,134.48z"/>
                            </svg>
                            <span className="absolute top-full left-1/2 -translate-x-1/2 mb-2 opacity-0 group-hover:opacity-100 transition-opacity bg-gray-800 text-white text-sm px-2 py-1 rounded-lg whitespace-nowrap z-10">
                                Portafolio
                            </span>
                        ...
                        {isDropdownOpen && (
                            <div className="absolute z-10 font-normal bg-white divide-y divide-gray-100 rounded-lg shadow-sm w-44 dark:bg-gray-700 dark:divide-gray-600"  onMouseLeave={() => setIsDropdownOpen(false)}>
                                <ul className="py-2 text-sm text-gray-700 dark:text-gray-400">
                                    <li>
                                        <a href="/dashboard/project_corporative" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-amber-500 dark:hover:text-white">
                                            Proyectos corporativos
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/dashboard/personal_project" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-amber-500 dark:hover:text-white">
                                ...
                                <div className="py-1">
                                    <a href="/dashboard/3d" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-amber-500 dark:text-gray-200 dark:hover:text-white">
                                        Diseños 3D Blender
                                    </a>
                                </div>
                            </div>
